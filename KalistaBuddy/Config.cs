...
namespace KalistaBuddy
{
    ...
    {
        private const string MenuName = "KalistaBuddy";
        ...
        internal static class Modes
        {
            ...
            internal static class LaneClear
            {
                ...
                static LaneClear()
                {
                    ...
                    UseQ = Menu.Add(new MenuSliderButton("UseQ", "Use Q to kill minions", 3, 1, 10) { BValue = false });
                    UseE = Menu.Add(new MenuSliderButton("UseE", "Use E to kill minions", 3, 1, 10) { BValue = true });
        ...
        internal static class Auto
        {
            ...
            internal static class AutoE
            {
                ...
                static AutoE()
                {
                    ...
                    _killSiegeMinions = Menu.Add(new MenuSliderButton("KillSiegeMinions", "Kill Siege Minions", 0, 0, 100, true) { BValue = true });
                    ...
                    _killUnkillableMinions = Menu.Add(new MenuSliderButton("KillUnkillableMinions", "Kill Minions unkillable with AutoAttack", 30, 0, 100, true) { BValue = true });
                    _KillMinionsToHarassEnemyHeros = Menu.Add(new MenuSliderButton("KillMinionsToHarassEnemyHeros", "Kill Minions to Harass Enemy heros", 50, 0, 100, true) { BValue = true });
                }
        ...
        internal static class Misc
        {
            ...
            static Misc()
            {
                ...
                _eDamageAdjust = Menu.Add(new MenuSliderButton("EDmageAdjust", "E Damage Adjust", -10, -100, 0) { BValue = false });
            }
