...
namespace BlitzBuddy
{
    internal static class DamageIndicator
    {
        ...
        internal class DamageInfo
        {
            ...
            internal Func<Obj_AI_Base, float> DamageCalcFunc;
            internal Func<bool> Enabled;
            internal string Tag;
        }

        private class JungleHpBarOffset
        {
